  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="newpost">
            <a href="{{ url('post/newPost') }}">
              <i class="nc-icon nc-email-85"></i>
              <p>Yangi Postlar <sup>
                <span class="badge badge-danger ml-2 new_badge" style="font-size:10px;">12</span></sup></p>
            </a>
          </li>
          <li class="category">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <form id="mainSearch"  action="{{ url('post/search') }}" method="post">
              @csrf
              <div class="input-group no-border">
                <input type="text" name="title" class="form-control" placeholder="Search...">
                <div class="input-group-append">
                  <div class="input-group-text" onclick="document.getElementById('mainSearch').submit()">
